...
// const APP_CHAIN_ID = ChainId.MATIC

const token_list_mainnet=
	{
		"PAX" : new Token(ChainId.MAINNET, '0x8e870d67f660d95d5be530380d0ec0bd388289e1', 18, 'PAX', 'PAX'),
		"FRAX" : new Token(ChainId.MAINNET, '0x853d955aCEf822Db058eb8505911ED77F175b99e', 18, 'FRAX', 'FRAX'),
		"RAI" : new Token(ChainId.MAINNET, '0x03ab458634910aad20ef5f1c8ee96f1d6ac54919', 18, 'RAI', 'RAI'),
		...
		"XSUSHI" : new Token(ChainId.MAINNET, '0x8798249c2E607446EfB7Ad49eC89dD1865Ff4272', 18, 'XSUSHI', 'XSUSHI'),
		"AmmDAI" : new Token(ChainId.MAINNET, '0x79bE75FFC64DD58e66787E4Eae470c8a1FD08ba4', 18, 'AmmDAI', 'AmmDAI'),
		"AmmUSDC" : new Token(ChainId.MAINNET, '0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48', 6, 'AmmUSDC', 'AmmUSDC'),
		"AmmUSDT" : new Token(ChainId.KOVAN, '0xf3e0d7bF58c5d455D31ef1c2d5375904dF525105', 6, 'USDT', 'Tether USD'),
	}
...
const TOKEN_LIST = token_list[APP_CHAIN_ID]
